...
public class PolicyFragment extends ListContentFragment {
    ...
    public Context getContext() {
        ...
        getActivity().getTheme().resolveAttribute(R.attr.largeIconTheme, value, true);
        mWrapper = new ContextThemeWrapper(getActivity(), value.resourceId);
        return mWrapper;
    }
    ...
    void setContent(final ListItem li, final UidPolicy up) {
        ...
        setContent(new LogFragment(), up == null, up == null ? getString(R.string.logs) : up.getName());
    }
