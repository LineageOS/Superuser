        ...
        addItem(R.string.settings, new ListItem(this, R.string.notifications, 0) {
            void update() {
                ...
                case Settings.NOTIFICATION_TYPE_NOTIFICATION:
                    setSummary(getString(R.string.notifications_summary, getString(R.string.notification_summary)));
                    break;
                case Settings.NOTIFICATION_TYPE_TOAST:
                    setSummary(getString(R.string.notifications_summary, getString(R.string.toast_summary)));
                    break;
                }
            }
